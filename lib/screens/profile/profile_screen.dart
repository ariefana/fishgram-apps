    ...
    return Scaffold(
      ...
      body: Consumer<AuthProvider>(
        builder: (context, auth, _) {
          ...
          if (user == null) return const Center(child: Text('Tidak ada data'));

          final catches = context.watch<FeedProvider>().catches.where((c) => c.userId == user.id).toList();
                ...
                if (catches.isEmpty)
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return CachedNetworkImage(imageUrl: catches[index].photoUrl, fit: BoxFit.cover);
                    },
                  ),
              ],
            ),
