    ...
    return Consumer<FeedProvider>(
      builder: (context, fp, _) {
        ...
        if (catchItem == null) {
          return Scaffold(
            appBar: AppBar(),
            body: const Center(child: Text('Tangkapan tidak ditemukan')),
          );
        }
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () =>
                            _showFullPhoto(context, catchItem!.photoUrl),
                        child: AspectRatio(
                          aspectRatio: 4 / 3,
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            // // const Icon(Ionicons.chatbubble_outline, size: 22),
