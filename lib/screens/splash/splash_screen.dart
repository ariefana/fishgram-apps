              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.phishing, size: 64, color: Colors.white),
                  ),
                  ...
                  SizedBox(
                    width: 28,
                    height: 28,
                    child: CircularProgressIndicator(strokeWidth: 2.5, valueColor: AlwaysStoppedAnimation(Colors.white.withValues(alpha: 0.7))),
                  ),
                ],
              ),
            ),
